...
$countS= getRaw("SELECT id FROM banner");
...
if (isPost()) {
    ...
    if (empty($errors)) {
        ...
        if($count <= 4){
            $InserStatus = insert('banner', $dataInsert);
        }else{
            setFlashData('msg', 'Bạn không được thêm qua 4 danh mục');
        ...
        if ($InserStatus) {
            ...
            setFlashData('msgType', 'danger');
            redirect('admin?module=banner&action=add');
        }
    } else {
        //Có lỗi xảy ra
        ...
        redirect('admin?module=banner&action=add'); //Load lại trang thêm người dùng
    }
}
            ...
            <div class="col-xl-6 ">
                <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="card-title mb-0">Thêm danh mục hot</h5>
                    </div>
                    <div class="card-body">
