...
if(!empty($token)){
    ...
    if(!empty($tokenQuery)){
        ...
        if(isPost()){
            ...
            if (empty(trim($body['fogotpassword']))){
                $errors['fogotpassword']['required'] = 'Xác nhận mật khẩu không được để trống';
            }else{
                if (trim($body['password'])!=trim($body['fogotpassword'])){
                    $errors['fogotpassword']['match'] = 'Hai mật khẩu không khớp nhau';
                }
            }
...
//                        getMsg($msg,$msgType);
//                    }else{
//                        echo '<p class="mb-4"> Bạn quên mật khẩu , chúng tôi sẽ hướng dẫn để đặt lại mật khẩu của bạn</p>';
//                    }
//
//                    ?>
                    ...
                    <form id="formAuthentication" class="mb-3" action="" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input
                                ...
                                placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;"
                            />
                            <?php echo form_error('fogotpassword', $errors, '<span class="text-danger">', '</span>'); ?>
                        </div>
                        <button type="submit" class="btn btn-primary d-grid w-100">Đổi mật khẩu</button>
                        <input type="hidden" name="token" value="<?php echo $token; ?>">
                    </form>
                    <div class="text-center">
                        <a href="?modules=auth&action=login" class="d-flex align-items-center justify-content-center">
