...
if(isPost()){
    ...
    if(!empty($body['email'])){
        $email = $body['email'];
        $userQuery = firstRaw("SELECT id FROM users WHERE email='$email'");
        ...
        setFlashData('msg', 'Vui lòng nhâp Email');
        setFlashData('msg_type', 'danger');
    }
}
...
<div class="card">
    <div class="card-body">
        ...
        <form id="formAuthentication" class="mb-3" action="" method="POST">
            ...
            <button type="submit" class="btn btn-primary d-grid w-100">Gửi liên kết đặt lại</button>
        </form>
        <div class="text-center">
            <a href="<?php echo getLinkAdmin('auth','login') ?>" class="d-flex align-items-center justify-content-center">
