...
$checkView= checkPermission($permissionsData,'categorys','view');
$checkAdd = checkPermission($permissionsData,'categorys','add');
$checkEdit = checkPermission($permissionsData,'categorys','edit');
$checkDelete = checkPermission($permissionsData,'categorys','delete');
...
if (!empty($keyword)) {
    $filter = "WHERE $module.name LIKE '%$keyword%'";
}
...
$allCategorysNumber = getRows("SELECT id FROM categorys $filter");

/* 1. Xác định số lượng bản ghi trên 1 trang */
$perPage = _PAGE; /* Mỗi trang có 3 bẳn ghi */

/* 2. Tính số trang */
$maxPage = ceil($allCategorysNumber / $perPage);
...
$listAllCateegorys = getRaw("SELECT categorys.id,categorys.name,users.name as user_name FROM categorys 
INNER JOIN users ON categorys.userID = users.id $filter ORDER BY categorys.createAt DESC LIMIT $offset,$perPage");
...
<div class="content-wrapper">
            ...
            <div class="col-lg-6">
                ...
                <div class="row">
                    <form action="" class="d-flex mb-3" method="get">
                        ...
                        <input type="hidden" name="module" value="categorys">
                ...
                <div class="card">
                    ...
                    <div class="table-responsive text-nowrap">
                        <table class="table">
                            ...
                            <?php
                            if(!empty($listAllCateegorys)):
                                $count = 0;
                                foreach($listAllCateegorys as $item):
                                    ...
                                    <tr>
                                        ...
                                        ?>
                                        <td>
                                            <a href="<?php echo getLinkAdmin($module,'',['id' => $item['id'],'view' => 'edit'])?>">
    ...
    ?>
    <script>
        var url = '?module=categorys&action=delete';
