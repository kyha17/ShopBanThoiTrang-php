...
trait MultipartUploadingTrait
{
    ...
    protected function determinePartSize()
    {
        ...
        // Adjust the part properties to be larger for known, x-large uploads.
        ...
        // Ensure that the part properties follows the rules: 5 MB <= properties <= 5 GB.
        if ($partSize < MultipartUploader::PART_MIN_SIZE || $partSize > MultipartUploader::PART_MAX_SIZE) {
            throw new \InvalidArgumentException('The part properties must be no less '
