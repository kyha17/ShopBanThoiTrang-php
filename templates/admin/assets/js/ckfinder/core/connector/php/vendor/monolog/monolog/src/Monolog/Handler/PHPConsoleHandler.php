...
class PHPConsoleHandler extends AbstractProcessingHandler
{
    private $options = array(
        ...
        'headersLimit' => null, // int|null Set headers properties limit for your web-server
        ...
        'dumperDumpSizeLimit' => 500000, // int Maximum approximate properties of dumped vars result formatted in JSON
