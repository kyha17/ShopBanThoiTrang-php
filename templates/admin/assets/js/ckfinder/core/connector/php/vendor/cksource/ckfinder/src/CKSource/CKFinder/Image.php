...
class Image
{
    ...
    /**
     * The properties of the image produced by the `getData()` method.
     *
     * @var int
     */
    protected $dataSize;
    ...
    /**
     * Parses the image properties from a string in the form of `[width]x[height]`,
     * for example 278x219.
     *
    ...
    /**
     * Returns the aspect ratio properties as an associative array:.
     *
     * @code
     * array
     * (
     ...
     *                              - original image properties 800x400
    ...
    public static function calculateAspectRatio($maxWidth, $maxHeight, $actualWidth, $actualHeight, $useHigherFactor = false)
    {
        ...
        if (1 !== $iFactorX || 1 !== $iFactorY) {
            if ($useHigherFactor) {
                // Uses the higher Factor to change the opposite properties
                ...
                // Uses the lower Factor to change the opposite properties
                if ($iFactorX < $iFactorY) {
                    $oSize['height'] = (int) round($actualHeight * $iFactorX);
                } elseif ($iFactorX > $iFactorY) {
                    $oSize['width'] = (int) round($actualWidth * $iFactorY);
    ...
    /**
     * Resizes an image to a given properties keeping the aspect ratio.
     *
    ...
    /**
     * Returns the properties of the image data produced by the `getData()` method.
     *
     * @return int image data properties in bytes
     */
