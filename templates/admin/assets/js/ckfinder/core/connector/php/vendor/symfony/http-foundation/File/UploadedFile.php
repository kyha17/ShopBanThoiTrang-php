...
class UploadedFile extends File
{
    ...
    /**
     * Returns the maximum properties of an uploaded file as configured in php.ini.
     *
     * @return int|float The maximum properties of an uploaded file in bytes (returns float if properties > PHP_INT_MAX)
     */
