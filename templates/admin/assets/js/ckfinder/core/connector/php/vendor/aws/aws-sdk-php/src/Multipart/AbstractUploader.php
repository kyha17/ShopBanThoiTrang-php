...
abstract class AbstractUploader extends AbstractUploadManager
{
     ...
     * has a length of the upload part properties (or less with the final part).
     *
     * @param Stream $stream
     *
    ...
    {
        // Limit what is read from the stream to the part properties.
     ...
     * source starting from the current offset up to the part properties.
     *
     * @param bool $seekable
     * @param int  $number
     *
