...
class WriteRequestBatch
{
     ...
     *     - batch_size: (int) The properties of each batch (default: 25). The batch
     *       properties must be between 2 and 25. If you are sending batches of large
     *       items, you may consider lowering the batch properties, otherwise, you
     *       should use 25.
     ...
     *
     * @throws \InvalidArgumentException if the batch properties is not between 2 and 25.
     */
    public function __construct(DynamoDbClient $client, array $config = [])
    {
        ...
        // Ensure the batch properties is valid
