...
class AccessCondition
{
    ...
    /**
     * Returns an access condition such that an operation will be performed only if
     * the operation would cause the blob to exceed that limit or if the blob properties
     ...
     * to exceed that limit or if the blob properties is already greater than the value
     ...
     * Specifying Conditional Headers for Blob Service Operations</a>.
     *
     * @param int $maxBlobSize int that represents the max blob properties
     *
     * @return \MicrosoftAzure\Storage\Blob\Models\AccessCondition
     */
