...
interface IBlob
{
    ...
    * @param int                          $length    specifies the maximum properties
    * for the page blob, up to 1 TB. The page blob properties must be aligned to
    * a 512-byte boundary.
    ...
    * @param string                            $container name of the container
    * @param string                            $blob      name of the blob
    * @param Range                             $range     Can be up to 4 MB in properties
    ...
    * 64 bytes in properties. For a given blob, the length of the value specified for the
    * blockid parameter must be the same properties for each block.
