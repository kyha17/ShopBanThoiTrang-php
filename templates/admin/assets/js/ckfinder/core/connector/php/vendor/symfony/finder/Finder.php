...
class Finder implements \IteratorAggregate, \Countable
{
     ...
     *
     *     $finder->properties('> 10K');
     *     $finder->properties('<= 1Ki');
     *     $finder->properties(4);
     *     $finder->properties(['> 10K', '< 20K'])
     *
     * @param string|int|string[]|int[] $sizes A properties range string or an integer or an array of properties ranges
     *
     * @return $this
     *
