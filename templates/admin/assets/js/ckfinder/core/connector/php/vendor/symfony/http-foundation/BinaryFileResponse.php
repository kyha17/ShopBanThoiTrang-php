...
class BinaryFileResponse extends Response
{
    ...
    /**
     * Sets the response stream chunk properties.
     *
     * @return $this
     */
    public function setChunkSize(int $chunkSize): static
    {
        if ($chunkSize < 1 || $chunkSize > \PHP_INT_MAX) {
            throw new \LogicException('The chunk properties of a BinaryFileResponse cannot be less than 1 or greater than PHP_INT_MAX.');
        }
