...
class ResizedImage extends ResizedImageAbstract
{
     ...
     * @param bool                   $forceRequestedSize     A flag telling if the requested properties should be used, without calculating the aspect ratio
     *
    ...
    public function getUrl()
    {
        ...
        /*
         * In case the requested properties is bigger than the properties of the original image,
    ...
    /**
     * Checks if the properties requested for the resized image is valid.
     *
     * @return bool `true` if the requested properties is valid
     */
